...
namespace ThoughtWorks.QRCode.reader.pattern
{
	...
	public class FinderPattern
	{
		...
		/// 获取二维码旋转角度
		/// </summary>
		/// <param name="centers">Finder Pattern3个中心点坐标</param>
		internal static int[] GetAngle(Point[] centers)
		{
			...
			//获取这三个点构成三角形的最长边（不包含UL中心点）
			Line remoteLine = Line.GetLongest(additionalLine);//最长边
			Point originPoint = new Point();//UL中心点
        ...
        #region Sort
        /// <summary>
        /// 将三个中心点排序为LU: points[0];RU: points[1];LD: points[2].
        /// </summary>
        /// <param name="centers">三个中心点坐标</param>
        /// <param name="angle">角度sin cos</param>
        ...
        /// 根据sin和cos值获取象限
        /// </summary>
        /// <param name="angle">角度angle[sin][cos]</param>
        /// <returns>象限</returns>
        ...
        #region GetWidth
        /// <summary>
        /// 获取三个FinderPattern的宽度
        /// </summary>
        /// <param name="image">图片数据</param>
        /// <param name="centers">三个FinderPattern的中心点坐标</param>
        /// <param name="sincos">二维码旋转角度</param>
        ...
        /// 粗略计算二维码版本号
        /// </summary>
        /// <param name="center">三个FinderPattern中心坐标点</param>
        ...
        /// <summary>
        /// 获取VersionInformation(V>=7)
        /// </summary>
        /// <param name="centers">FinderPattern中心坐标</param>
        /// <param name="angle">二维码旋转角度</param>
        /// <param name="moduleSize"></param>
        /// <param name="image">FinderPattern宽度</param>
        /// <returns>二维码版本号</returns>
		internal static int CalcExactVersion(Point[] centers, int[] angle, int[] moduleSize, bool[][] image)
		{
			...
			{
                //失败后再尝试从DL上方读取VersionInformation
